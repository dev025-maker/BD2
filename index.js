...
function sortByAscPricing(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}

function sortByDscPricing(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing === 'low-to-high') {
    hotelsCopy.sort(sortByAscPricing);
  } else {
    hotelsCopy.sort(sortByDscPricing);
  }
  res.json({ hotels: hotelsCopy });
});

function sortByAscRating(hotel1, hotel2) {
  return hotel1.rating - hotel2.rating;
}

function sortByDscRating(hotel1, hotel2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating === 'low-to-high') {
    hotelsCopy.sort(sortByAscRating);
  } else {
    hotelsCopy.sort(sortByDscRating);
  }
  res.json({ hotels: hotelsCopy });
});

function sortReviewsAsc(hotel1, hotel2) {
  return hotel1.reviews - hotel2.reviews;
}

function sortReviewsDsc(hotel1, hotel2) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews === 'least-to-most') {
    hotelsCopy.sort(sortReviewsAsc);
  } else {
    hotelsCopy.sort(sortReviewsDsc);
  }
  res.json({ hotels: hotelsCopy });
});
